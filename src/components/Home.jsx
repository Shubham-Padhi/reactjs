...
const Home = () => {
  ...
  <source
    ...
    <p className="mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-800 ">
     Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro expedita aliquid eos vero assumenda dolor ut beatae doloribus repellat dolorum. Odit voluptatibus nostrum corrupti ipsum, cupiditate nemo explicabo neque hic?
    </p>
  </div>
</main>
